...
![image]({{ site.baseurl }}/assets/images/2013/12/image_thumb14.png)
...
![image]({{ site.baseurl }}/assets/images/2013/12/image_thumb7.png)

Next I added a OWIN Startup class.

![image]({{ site.baseurl }}/assets/images/2013/12/image_thumb8.png)

And then I added the usual _**app.MapSignalR();**_ statement and went on to the next task.
...
The fantastic people behind [Nancy](http://nancyfx.org/) had already made sure there was an [OWIN](http://owin.org/) package available for me so using _**Install-Package Nancy.Owin**_ I pulled down some more awesome code.

![image]({{ site.baseurl }}/assets/images/2013/12/image_thumb9.png)
...
![image]({{ site.baseurl }}/assets/images/2013/12/image_thumb10.png)
...
![image]({{ site.baseurl }}/assets/images/2013/12/image_thumb11.png)
...
![image]({{ site.baseurl }}/assets/images/2013/12/image_thumb12.png)
...
namespace HugoHaggmark.Taskmanager.Hubs
{
  public class CpuHub : Hub
  {
    ...
    public CpuHub() : this(Broadcaster.Instance)
    {
...
![image]({{ site.baseurl }}/assets/images/2013/12/image_thumb13.png)
...
1. Firstly the _**$.connection.cpuHub**_ statement must match the name of the hub class you’re connecting to
2. In the Broadcaster class we’re calling _**Clients.All.cpuInfo(Environment.MachineName, cpu.ToString());**_ so we need to register the same method in our client like the _**cpuHub.client.cpuInfo**_ statement above does.

The rest is boilerplate code to make the chart work and look nicely and you can find all the code at [https://github.com/hugohaggmark/HugoHaggmark.Blog/tree/master/HugoHaggmark.Taskmanager](https://github.com/hugohaggmark/HugoHaggmark.Blog/tree/master/HugoHaggmark.Taskmanager).
